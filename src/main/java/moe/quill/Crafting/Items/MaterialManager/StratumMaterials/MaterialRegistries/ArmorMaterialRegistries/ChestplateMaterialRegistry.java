...
import moe.quill.Crafting.Items.MaterialManager.StratumMaterials.BaseArmorAttributes.BaseAttributesChestplates;
...
public class ChestplateMaterialRegistry extends MaterialRegistry {
    public ChestplateMaterialRegistry(KeyManager keyManager) {
