package moe.quill.Crafting.Items.MaterialManager.StratumMaterials.MaterialRegistries.ToolMaterialRegistries;
...
public class IcepickRegistry extends MaterialRegistry {
    public IcepickRegistry(KeyManager keyManager) {
