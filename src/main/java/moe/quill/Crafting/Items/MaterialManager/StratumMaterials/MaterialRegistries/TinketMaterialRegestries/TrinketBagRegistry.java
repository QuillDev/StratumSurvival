...
public class TrinketBagRegistry extends MaterialRegistry {
    ...
    public HashMap<String, ItemStack> getMaterials() {
        return new HashMap<>() {{
            ...
            TRINKET_BAG_SMALL_DATA.set(inventorySizeKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeFloat(3));
            TRINKET_BAG_SMALL_DATA.set(itemDataKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeItemList(emptyItemList));
            ...
            TRINKET_BAG_MEDIUM_DATA.set(inventorySizeKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeFloat(5));
            TRINKET_BAG_MEDIUM_DATA.set(itemDataKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeItemList(emptyItemList));
            ...
            TRINKET_BAG_LARGE_DATA.set(inventorySizeKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeFloat(7));
            TRINKET_BAG_LARGE_DATA.set(itemDataKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeItemList(emptyItemList));
            ...
            TRINKET_BAG_HUGE_DATA.set(inventorySizeKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeFloat(9));
            TRINKET_BAG_HUGE_DATA.set(itemDataKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeItemList(emptyItemList));
