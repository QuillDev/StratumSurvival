...
public abstract class BowWeaponAttribute extends Attribute {
    ...
    public BowWeaponAttribute(MaterialManager materialManager, KeyManager keyManager, AttributeKey key, Component lore, float scaleValue, float minRoll, float maxRoll) {
