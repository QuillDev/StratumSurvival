...
public class TrinketBagRegistry extends MaterialRegistry {
    ...
    public HashMap<String, ItemStack> getMaterials() {
        return new HashMap<>() {{
            ...
            final var SMALL_TRINKET_BAG = new ItemStack(Material.LEATHER);
            ...
            final var MEDIUM_TRINKET_BAG = new ItemStack(Material.LEATHER);
            ...
            final var LARGE_TRINKET_BAG = new ItemStack(Material.LEATHER);
