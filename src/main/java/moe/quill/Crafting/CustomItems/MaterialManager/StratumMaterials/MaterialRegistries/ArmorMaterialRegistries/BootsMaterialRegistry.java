...
public class BootsMaterialRegistry extends MaterialRegistry {
    ...
    public HashMap<String, ItemStack> getMaterials() {
        return new HashMap<>() {{
            ...
            BOOTS_LEATHER_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            BOOTS_GOLDEN_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            BOOTS_CHAIN_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            BOOTS_IRON_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            BOOTS_DIAMOND_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            BOOTS_NETHERITE_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
