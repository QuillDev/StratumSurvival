...
public class HelmetMaterialRegistry extends MaterialRegistry {
    ...
    public HashMap<String, ItemStack> getMaterials(NamespacedKey itemKey) {
        return new HashMap<>() {{
            ...
            HELMET_LEATHER_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            HELMET_GOLDEN_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            HELMET_CHAIN_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            HELMET_IRON_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            HELMET_DIAMOND_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            HELMET_NETHERITE_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
