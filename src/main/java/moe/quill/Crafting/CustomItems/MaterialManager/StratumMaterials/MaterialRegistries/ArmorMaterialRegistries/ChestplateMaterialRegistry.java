...
public class ChestplateMaterialRegistry extends MaterialRegistry {
    ...
    public HashMap<String, ItemStack> getMaterials() {
        return new HashMap<>() {{
            ...
            CHESTPLATE_LEATHER_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            CHESTPLATE_GOLDEN_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            CHESTPLATE_CHAIN_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            CHESTPLATE_IRON_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            CHESTPLATE_DIAMOND_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
            ...
            CHESTPLATE_NETHERITE_JUG_META.getPersistentDataContainer().set(itemKey, PersistentDataType.BYTE_ARRAY, StratumSerialization.serializeBoolean(true));
